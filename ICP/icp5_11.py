# -*- coding: utf-8 -*-
"""
Created on Fri Feb 22 16:24:51 2019
...
plt.scatter(X[y_kmeans == 0, 1], X[y_kmeans == 0, 2], s = 100, c = 'red', marker = '+', label = 'Cluster 1')
plt.scatter(X[y_kmeans == 1, 1], X[y_kmeans == 1, 2], s = 100, c = 'blue',marker = '*', label = 'Cluster 2')
plt.scatter(X[y_kmeans == 2, 1], X[y_kmeans == 2, 2], s = 100, c = 'green',marker = 'o', label = 'Cluster 3')
